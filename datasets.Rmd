...
data()
```
 If you want more information, the following index will link you to the package information page for those listed above.    
https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/  
  
  
If that's not enough!  There is a package called 'datasets' that will give you access to even more!  
